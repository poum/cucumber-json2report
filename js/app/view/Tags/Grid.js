...
*/
Ext.define('CJ2H.view.Tags.Grid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.TagsGrid',
	...
	this.columns = [ {
		...
		summaryRenderer: function(value) {
			return Ext.String.format('{0} {1}', value, value < 2 ? msg.tag : msg.tags);
		}
	},{
		text: msg.featureNumber,
		...
		text: msg.featurePassed,
		dataIndex: 'featurePassedNumber',
		sortable: true,
		align: 'center',
		summaryType: 'sum',
		summaryRenderer: function(value) {
		...
		text: msg.featureFailed,
		dataIndex: 'featureFailedNumber',
		sortable: true,
		align: 'center',
		summaryType: 'sum',
		summaryRenderer: function(value) {
		...
		text: msg.scenarioPassed,
		dataIndex: 'scenarioPassedNumber',
		sortable: true,
		align: 'center',
		summaryType: 'sum',
		summaryRenderer: function(value) {
		...
		text: msg.scenarioFailed,
		dataIndex: 'scenarioFailedNumber',
		sortable: true,
		align: 'center',
		summaryType: 'sum',
		summaryRenderer: function(value) {
